...
public class Application1 {
    public static void main(String[] args) {
        ...
        *   그리고 조회와 달리 executeQuery()가 아닌 executeUpdaet()를 사용한다.
        * */
        int result = 0;
        ...
        try {
            ...
            *   잘못 들어간 데이터를 지우고 auto_increment를 초기화한 후 insert를 다시 해야한다.
            *   ex)
            *   delete from tbl_menu where menu_code = 28;
            *   alter table tbl_menu auto_increment = 24; -- auto_increment가 다시 24번부터 생성되도록 초기화
            *   그니까 23까지 있다가 commit, rollback을 하다보니 23 -> 28이 된 경우
            *   다시 auto_increment를 24부터 시작되게 바꾸는거다.
            * */
